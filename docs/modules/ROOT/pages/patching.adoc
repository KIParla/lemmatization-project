...
Questa guida descrive il workflow per riportare tali correzioni automaticamente nel file sorgente del corpus, senza interrompere il lavoro di lemmatizzazione.
